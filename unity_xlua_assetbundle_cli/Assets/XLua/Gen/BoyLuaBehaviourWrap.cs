...
namespace XLua.CSObjectWrap
{
    ...
    public class BoyLuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BoyLuaBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BoyLuaBehaviour __cl_gen_ret = new BoyLuaBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BoyLuaBehaviour constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                BoyLuaBehaviour __cl_gen_to_be_invoked = (BoyLuaBehaviour)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                BoyLuaBehaviour __cl_gen_to_be_invoked = (BoyLuaBehaviour)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.injections = (BoyInjection[])translator.GetObject(L, 2, typeof(BoyInjection[]));
