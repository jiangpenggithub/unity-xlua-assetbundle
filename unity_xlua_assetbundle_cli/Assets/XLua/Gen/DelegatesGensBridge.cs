...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LoadingCallback))
			{
			    return new LoadingCallback(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(HttpMsgCallback))
			{
			    return new HttpMsgCallback(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(ConnectCallback))
			{
			    return new ConnectCallback(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(OnMessageCallback))
			{
			    return new OnMessageCallback(__Gen_Delegate_Imp3);
			}
