...
namespace XLua.CSObjectWrap
{
    ...
    public class HttpUtilsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(HttpUtils);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "TimeOut", HttpUtils.TimeOut);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					HttpUtils __cl_gen_ret = new HttpUtils();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to HttpUtils constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    HttpMsgCallback callback = translator.GetDelegate<HttpMsgCallback>(L, 4);
                        ...
                        System.Collections.IEnumerator __cl_gen_ret = HttpUtils.SendHttpMsg( url, method, param, callback );
